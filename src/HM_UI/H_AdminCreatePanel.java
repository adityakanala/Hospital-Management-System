 ...
 * @author adity
 */
public class H_AdminCreatePanel extends javax.swing.JPanel {
    ...
    public H_AdminCreatePanel(PatientHistory patientHistory, DoctorDirectory doctorDirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(lblHeading1);
        lblHeading1.setBounds(233, 49, 685, 62);
        ...
        add(lblHeading2);
        lblHeading2.setBounds(401, 142, 363, 29);

        lblName.setText("Name :");
        add(lblName);
        lblName.setBounds(215, 253, 38, 16);

        lblEmail.setText("Email :");
        add(lblEmail);
        lblEmail.setBounds(215, 289, 35, 16);

        lblPassword.setText("Password :");
        add(lblPassword);
        lblPassword.setBounds(215, 328, 56, 16);

        lblGender.setText("Gender : ");
        add(lblGender);
        lblGender.setBounds(215, 362, 47, 16);

        lblPhone.setText("Contact Number :");
        add(lblPhone);
        lblPhone.setBounds(215, 399, 95, 16);
        add(txtName);
        txtName.setBounds(314, 253, 350, 22);
        add(txtEmail);
        txtEmail.setBounds(314, 287, 350, 22);
        add(txtPhone);
        txtPhone.setBounds(314, 399, 350, 22);
        add(txtPassword);
        txtPassword.setBounds(314, 327, 350, 22);
        ...
        add(cbGender);
        cbGender.setBounds(314, 361, 159, 22);

        lblRole.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        lblRole.setText("Role :");
        add(lblRole);
        lblRole.setBounds(233, 454, 75, 16);
        ...
        add(cbRole);
        cbRole.setBounds(359, 451, 153, 22);
        ...
        add(btnSignUP);
        btnSignUP.setBounds(423, 797, 112, 23);

        lblDAge.setText("Age :");
        add(lblDAge);
        lblDAge.setBounds(265, 520, 27, 16);

        lblSpeciality.setText("Speciality :");
        add(lblSpeciality);
        lblSpeciality.setBounds(237, 567, 56, 16);

        lblExperience.setText("Experience :");
        add(lblExperience);
        lblExperience.setBounds(231, 607, 63, 16);
        add(txtDAge);
        txtDAge.setBounds(324, 517, 112, 22);
        add(txtSpeciality);
        txtSpeciality.setBounds(324, 564, 112, 22);
        add(txtExperience);
        txtExperience.setBounds(324, 604, 112, 22);

        lblPAge.setText("Age :");
        add(lblPAge);
        lblPAge.setBounds(560, 517, 27, 16);

        lblHeight.setText("Height (in cms) :");
        add(lblHeight);
        lblHeight.setBounds(502, 567, 88, 16);

        lblWeight.setText("Weight (in lbs) :");
        add(lblWeight);
        lblWeight.setBounds(502, 607, 83, 16);
        add(txtPAge);
        txtPAge.setBounds(614, 517, 121, 22);
        add(txtHeight);
        txtHeight.setBounds(614, 564, 121, 22);
        add(txtWeight);
        txtWeight.setBounds(614, 604, 121, 22);

        lblHospitalName.setText("Hospital Name :");
        add(lblHospitalName);
        lblHospitalName.setBounds(207, 644, 85, 16);

        lblHospitalLocation.setText("Hospital Location :");
        add(lblHospitalLocation);
        lblHospitalLocation.setBounds(194, 684, 99, 16);
        add(txtHospitalName);
        txtHospitalName.setBounds(324, 644, 191, 22);
        add(txtHospitalLocation);
        txtHospitalLocation.setBounds(324, 684, 191, 22);
