 ...
 * @author adity
 */
public class SysAdminEncounter extends javax.swing.JPanel {

    /**
     * Creates new form SysAdminEncounter
     */
    ...
    public SysAdminEncounter(EncounterDetails encounterDetails, CommunityDirectory communityDirectory, PatientHistory patientHistory, DoctorDirectory doctorDirectory, JSplitPane sp, HospitalDirectory hospitalDirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(btnBook);
        btnBook.setBounds(881, 845, 140, 23);
        ...
        add(btnDelete);
        btnDelete.setBounds(913, 650, 120, 23);

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\adity\\Downloads\\encounter_1410x1130.png")); // NOI18N
        jLabel1.setText("jLabel1");
        add(jLabel1);
        jLabel1.setBounds(0, 0, 1580, 1130);

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("System Admin's Encounter View");
        add(jLabel2);
        jLabel2.setBounds(247, 10, 650, 40);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        int selectedRowIndex = tblEncounterView.getSelectedRow();
        ...
        String patient = String.valueOf(model.getValueAt(selectedRowIndex, 0));
         String doctor = String.valueOf(model.getValueAt(selectedRowIndex, 1));
        Encounter selectedEncounter = getEncounterByPandD(patient,doctor);

        encounterDetails.deleteEncounter(selectedEncounter);
