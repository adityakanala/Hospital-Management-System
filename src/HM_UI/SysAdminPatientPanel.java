 ...
 * @author adity
 */
public class SysAdminPatientPanel extends javax.swing.JPanel {

    /**
     * Creates new form SysAdminPatient
     */
   ...
   EncounterDetails encounterDetails;
    ...
    public SysAdminPatientPanel(HouseDirectory houseDirectory, EncounterDetails encounterDetails, CommunityDirectory communityDirectory, PatientHistory patientHistory, DoctorDirectory doctorDirectory, JSplitPane sp, HospitalDirectory hospitalDirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(220, 170, 670, 110);
        ...
        add(btnViewPatient);
        btnViewPatient.setBounds(230, 310, 93, 23);
        ...
        btnUpdatePDetails.setBounds(440, 310, 130, 23);
        ...
        add(btnDelete);
        btnDelete.setBounds(740, 310, 103, 23);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(selectedRowIndex<0){
            JOptionPane.showMessageDialog(this,"Please Select an Patient to Delete");
            return;
        }
        DefaultTableModel model = (DefaultTableModel) tblPatientView.getModel();
        Patient selectedPatient=(Patient) model.getValueAt(selectedRowIndex, 0);
